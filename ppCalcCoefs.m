function pCoefs = ppCalcCoefs(a,psi0,nf,na,dzdx)
...
jQAf = weight(tcf,gam,gam).*myJacobiQ2(nf-2,gam,1/2,tcf);
...
jQAa = weight(t1fun(tca),gam,gam).*myJacobiQ2(nf-2,gam,1/2,t1fun(tca));
